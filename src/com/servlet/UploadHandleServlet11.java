...
public class UploadHandleServlet11 extends HttpServlet {
        ...
        try{
            ...
            for(FileItem item : list){
                ...
                if(item.isFormField()){
                    ...
                    else if(name.contains("identification")){
                    ...
                    String temp_filename = "E:\\WebPrintTest\\out\\artifacts\\WebPrintTest_war_exploded\\WEB-INF\\files\\" + filename;
